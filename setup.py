"""
hardclustersets Copyright (C) 2015  Steven Cutting
"""
...
PACKAGES = ['hardclustersets']


setup(
    name="hardclustersets",
    version="0.1.0",
    license='GNU GPL v3+',
    description="NLP library",   # UPDATE INFO
